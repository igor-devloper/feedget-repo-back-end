...
const submit_feedbacks_function_1 = require("./submit-feedbacks-function");
const createFeedbackSpy = jest.fn();
const sendMailSpy = jest.fn();
const submitFeedback = new submit_feedbacks_function_1.SubmitFeedbackFunction({ create: createFeedbackSpy }, { sendMail: sendMailSpy });
